...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="employee-info">
                <div class="info-row">
                    ...
                    <span class="value">#' . str_pad($employee['id'], 5, '0', STR_PAD_LEFT) . '</span>
                </div>
            ...
            <div class="logo-container">
                <h3 style="color: #666; margin-bottom: 15px;">Employee Photo</h3>
                ' . $logoHtml . '
            </div>' : '') . '
        </div>
        ...
        <div class="footer">
            ...
            <p>© ' . date('Y') . ' Employee Management System. All rights reserved.</p>
