...
function setupValidation() {
    ...
    $('#employeeForm').validate({
        ...
        messages: {
            ...
            employeeLogo: {
                required: "Employee logo is required." 
            }
        },
        errorPlacement: function(error, element) {
            if (element.attr("name") == "employeeName") {
                $("#nameError").html(error);
            } else if (element.attr("name") == "employeeEmail") {
                $("#emailError").html(error);
            } else if (element.attr("name") == "employeeLogo") {
                $("#logoError").html(error);
            }
        }
    });
}
